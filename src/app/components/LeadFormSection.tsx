...
//       // Google Apps Script عادةً يرجع opaque response مع POST، لكن proxy Vite هيتعامل معاها
...
//       {isSubmitted && (
//         <div className="bg-green-50 border border-green-200 p-4 rounded mb-4 flex items-center gap-2">
//           <CircleCheck className="text-green-600" />
//           <span className="text-green-800">تم الإرسال بنجاح!</span>
//         </div>
//       )}
//       {errorMessage && (
//         <div className="bg-red-50 border border-red-200 p-4 rounded mb-4 flex items-center gap-2">
...
//         <input {...register('name', { required: 'الاسم مطلوب' })} placeholder="الاسم" className="w-full border px-4 py-2 rounded" />
//         {errors.name && <p className="text-red-600">{errors.name.message}</p>}

//         <input {...register('phone', { required: 'رقم الهاتف مطلوب' })} placeholder="رقم الهاتف" className="w-full border px-4 py-2 rounded" />
//         {errors.phone && <p className="text-red-600">{errors.phone.message}</p>}

//         <input {...register('companyName')} placeholder="اسم المصنع (اختياري)" className="w-full border px-4 py-2 rounded" />
//         <textarea {...register('requirements', { required: 'يرجى إدخال الاحتياج' })} placeholder="الاحتياج المعدني" className="w-full border px-4 py-2 rounded" />
//         {errors.requirements && <p className="text-red-600">{errors.requirements.message}</p>}

//         <select {...register('hasDrawings', { required: 'اختر' })} className="w-full border px-4 py-2 rounded">
//           <option value="">هل لديك رسومات؟</option>
//           <option value="نعم">نعم</option>
//           <option value="لا">لا</option>
//         </select>
//         {errors.hasDrawings && <p className="text-red-600">{errors.hasDrawings.message}</p>}

//         <select {...register('projectType')} className="w-full border px-4 py-2 rounded">
//           <option value="">نوع المشروع (اختياري)</option>
//           <option value="تشكيل معادن">تشكيل معادن</option>
//           <option value="أعمال لحام">أعمال لحام</option>
...
//         <button type="submit" className="w-full bg-orange-500 text-white py-2 rounded" disabled={isSubmitting}>
            ...
            <div className="space-y-6">
              ...
              <div className="text-right">
                ...
                >
                  ...
                  <option value="تشكيل معادن">تشكيل معادن</option>
                  <option value="أعمال لحام">أعمال لحام</option>
                  <option value="قص ليزر وCNC">قص ليزر وCNC</option>
                  <option value="هياكل معدنية">هياكل معدنية</option>
                  <option value="رفايع واسطمبات">رفايع واسطمبات</option>
                  <option value="جلفنة">جلفنة</option>
                  <option value="أخرى">أخرى</option>
